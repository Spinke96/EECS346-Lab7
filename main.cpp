//This is the old template. I have it saved just cause
...
//     int counter = 0;
//     fstream input_file;
//     ifstream input_file("matrix_input.txt", ios::in);
//     if(input_file.is_open()){
//         string line;
//         while(getline(input_file, line, ' ')){
//             int col =0;
//             matrix_1[counter][col] = stoi(line);
//             col += 1;
...
// void print_matrixs(const double matrix_1[][MAX_SIZE], const double matrix_2[][MAX_SIZE], int matrix_size) {
...
//     print_matrixs(matrix_1, matrix_2, matrix_size);
